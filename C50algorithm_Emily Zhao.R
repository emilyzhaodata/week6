...
#The model use computation to find the best rule that splits the data. With each node splitting data, the output model can be used to assign predict a class to new unclassified data items.
#the model used the decision tree model to predict how the length and width of Sepal and Petal can influence the type of species. 

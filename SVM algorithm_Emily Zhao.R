...
#The model used SVM to find a linear separator which can be drawn in-between two classes in order to separate all data points into one class of another. 
#The model split the data and generate parameters which are tuned in to optimize the model. 
